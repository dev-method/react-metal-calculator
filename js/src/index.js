        ...
        return(
            ...
            <div className="measures">РАЗМЕРЫ</div>
              ...
              <div className="list-container">
                  <div className="container-header">
                      <div className="header-back"><h3>МАТЕРИАЛ</h3></div>
                  </div>
                  <div className="materials-list">
                    <div>
                  {this.state.metalls.map((item,i)=>{
                      return <div className={item.id===this.state.active.id?"materials-list-item-active":"materials-list-item"} key={i} onClick={this.handleListClick.bind(this,item)}>{item.name}</div>
                                                     }
                                         )
                   }
                    </div>
